...
vim.keymap.set("n", "<leader>Tb", function() require("gitsigns").toggle_current_line_blame() end, { desc = "Toggle blame" })
vim.keymap.set("n", "<leader>Td", function() require("gitsigns").preview_hunk_inline() end, { desc = "Toggle deleted" })
...
vim.keymap.set("n", "<leader>sn", function() builtin.find_files { cwd = vim.fn.stdpath "config" } end, { desc = "Neovim config" })
...
vim.keymap.set("n", "<leader>gu", function() require("gitsigns").undo_stage_hunk() end, { desc = "Undo stage" })
...
vim.keymap.set("n", "<leader>gd", function() require("gitsigns").diffthis() end, { desc = "Diff index" })
...
vim.keymap.set("n", "<leader>pe", ":Neotree toggle position=left<CR>", { desc = "Explorer" })
vim.keymap.set("n", "<leader>pg", ":Neotree float git_status<CR>", { desc = "Git status" })
